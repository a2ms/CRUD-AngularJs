...
<head>
	...
	<title>Berbagi_app - Panti Belum Terverifikasi</title>
			...
			<nav class="navbar navbar-transparent navbar-absolute">
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse">
						...
						<form class="navbar-form navbar-right" role="search" action="<?php echo site_url('search_panti_b');?>" method="post">
	                        ...
	                        <div class="card">
	                            ...
	                            <div class="card-content table-responsive">
	                                <table class="table">
										...
										<?php
										$start = 0;
										foreach ($data_panti_s as $get_panti)
										{
										?>
	                                    <tbody>
	                                        <tr>
