...
class Admin_Panti_Asuhan extends CI_Controller {
  ...
  public function panti_asuhan_terverifikasi()
	{		
		...
		$config['base_url'] = base_url().'index.php/Admin_Panti_Asuhan/panti_asuhan_terverifikasi/';
	...
	{		
		...
		$config['base_url'] = base_url().'index.php/Admin_Panti_Asuhan/panti_asuhan_belum_terverifikasi/';
		$config['total_rows'] = $jumlah_data;
		$config['per_page'] = 10;
		$from = $this->uri->segment(3);
		$this->pagination->initialize($config);
