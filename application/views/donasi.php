...
<body>
	...
	<form class="form" action="<?php echo site_url('verifikasidana'); ?>" method="post" enctype="multipart/form-data">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
				...
				<div class="modal-body">
				<input type="hidden" name="id_donasi_dana" />
				...
				<div class="modal-footer text-center">
					<button type="submit" class="btn btn-info btn-round">Verifikasi</button>
