	                            ...
	                            <div class="card-content table-responsive">
	                                <table class="table">
										<?php if(isset($_SESSION)) {
										  ...
										  {
											echo '<div class="alert alert-warning"> <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>' .$this->session->flashdata('flash_data'). '</div>';
																	  }
										  } ?>
