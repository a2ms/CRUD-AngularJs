	                        ...
	                        <div class="card">
	                            ...
	                            <div class="card-content">
	                                <form>
										...
										<button type="button" class="btn btn-info pull-right" onclick="EditData(<?php echo $id_kegiatan?>)">Edit</button>
...
<!-- Sart Modal Disetujui -->
	...
	<form class="form" action="<?php echo site_url('updatesetuju'); ?>" method="post" enctype="multipart/form-data">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title">Peringatan!!!</h4>
...
<!-- Sart Modal Ditolak -->
	...
	<form class="form" action="<?php echo site_url('updatetolak'); ?>" method="post" enctype="multipart/form-data">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title">Peringatan!!!</h4>
...
<!-- Sart Modal Menunggu -->
	...
	<form class="form" action="<?php echo site_url('updatemenunggu'); ?>" method="post" enctype="multipart/form-data">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title">Peringatan!!!</h4>
...
<!-- Sart Modal Detail Data -->
	...
	<form class="form" action="<?php echo site_url('updatekegiatan'); ?>" method="post" enctype="multipart/form-data">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
				...
				<input type="hidden" name="id_kegiatan" />
					...
					<div class="form-group">
						<label class="control-label">Deskripsi Kegiatan</label>
						<input type="text" name="deskripsi_kegiatan" class="datepicker form-control" required>
					</div>
				</div>
				<div class="modal-footer">
...
function EditData(id_kegiatan)
{
    //Ajax Load data from ajax
    $.ajax({
        url : "<?php echo site_url('Admin_Kegiatan/ajax_edit')?>/" + id_kegiatan,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            ...
            $('[name="tanggal_kegiatan"]').val(data.tanggal_kegiatan);
			$('[name="jam_kegiatan"]').val(data.jam_kegiatan);
